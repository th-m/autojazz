...
//           // notes: scribble.scale(tone+'3', 'major', 3), // this works too ['c3', 'd3', 'e3', 'f3', 'g3', 'a3', 'b3']
//           notes: ['c3', 'd3', 'e3', 'f3', 'g3', 'a3', 'b3'], // this works too ['c3', 'd3', 'e3', 'f3', 'g3', 'a3', 'b3']
//           pattern: 'x-'.repeat(8)
//       });
//       // TODO: write midi to file, generalize naming for downloads/wav rendering
//       scribble.midi(melody, 'public/midi/'+tone+'scale.mid'); 
//       var instrumentName = "flute";
// 
//       // MIDI.loadPlugin({
//       //   soundfontUrl: "path/to/instruments/soundfonts/",
...
//       });
//       // TODO: write midi to file, generalize naming for downloads/wav rendering
//       // scribble.midi(clip, 'public/midi/'+tone+'scale.mid'); 
//       resolve(clip);
//   });
// }
...
router.get('/read/:file', function(req, res, next) {
  if(req.params.file){
    // songGen.data.readFile('public/midi/'+req.params.file).then(function(songData){
    songGen.data.readFile('public/midi/'+req.params.file).then(function(data){
      ...
      // res.render('mc/index', { title: 'Reading Files', songData: songData, note: req.params.file});
    // });
  }
});
